...
And finally, I've created a second, independent tidy data set with the average of each variable for each activity and each subject and saved it as a txt file, following projest's step 5.
